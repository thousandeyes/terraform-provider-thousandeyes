...
var CommonSchema = map[string]*schema.Schema{
	...
	"client_certificate": {
		...
		Optional:         true,
		DiffSuppressFunc: ClientCertificateDiffSuppress,
	},
	// contentRegex
	"content_regex": {
		Type:        schema.TypeString,
	...
	"request_method": {
		Type:        schema.TypeString,
		Description: "HTTP request method. Use GET to omit a request body or POST to send post_body, including an empty body.",
		Optional:    true,
		Computed:    true,
