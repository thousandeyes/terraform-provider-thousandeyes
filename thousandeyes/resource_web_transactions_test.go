	...
	var testCases = []struct {
	...
	}{
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttr(httpResourceName, "test_name", "A User Acceptance Test - Web Transactions"),
			...
			checkUpdateFunc: []resource.TestCheckFunc{
				resource.TestCheckResourceAttr(httpResourceName, "url", "https://www.thousandeyes.com"),
				resource.TestCheckResourceAttr(httpResourceName, "test_name", "A User Acceptance Test - Web Transactions (Updated)"),
