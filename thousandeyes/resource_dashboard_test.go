	...
	var testCases = []struct {
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttr(resourceNameNumberWidget, "widgets.0.number_cards.0.metric", "ALERT_COUNT_AGENT"),
				...
				resource.TestCheckResourceAttr(resourceNameNumberWidget, "widgets.0.number_cards.1.description", "Active Alerts"),
				resource.TestCheckResourceAttr(resourceNameNumberWidget, "widgets.0.number_cards.1.metric", "ACTIVE_ALERT_COUNT"),
				resource.TestCheckResourceAttr(resourceNameNumberWidget, "widgets.0.number_cards.1.measure.0.type", "MEAN"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttr(resourceNameNumberWidget, "widgets.0.number_cards.0.fixed_timespan.0.unit", "Days"),
				resource.TestCheckResourceAttr(resourceNameNumberWidget, "widgets.0.number_cards.1.description", "Active Alerts (Updated)"),
