...
func TestAccThousandEyesDashboard(t *testing.T) {
	...
	var resourceNameCustomerShapeWidgetTypes = "thousandeyes_dashboard.test_dashboard_customer_shape_widget_types"
	...
	var testCases = []struct {
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameMapWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameMapWidget, "widgets.0.geo_map_config.0.min_scale"),
				resource.TestCheckResourceAttrSet(resourceNameMapWidget, "widgets.0.geo_map_config.0.max_scale"),
				resource.TestCheckResourceAttr(resourceNameMapWidget, "widgets.0.geo_map_config.0.group_by", "COUNTRY"),
				resource.TestCheckResourceAttrSet(resourceNameMapWidget, "widgets.0.geo_map_config.0.is_geo_map_per_test"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
		...
		{
			name:                 "create_update_delete_dashboard_customer_shape_widget_types_test",
			createResourceFile:   "acceptance_resources/dashboard/widget_customer_shape_basic.tf",
			updateResourceFile:   "acceptance_resources/dashboard/widget_customer_shape_update.tf",
			resourceName:         resourceNameCustomerShapeWidgetTypes,
			checkDestroyFunction: testAccCheckDashboardResourceDestroy,
			checkCreateFunc: []resource.TestCheckFunc{
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "title", "Customer Dashboard A"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "description", ""),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "is_private", "false"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.#", "10"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.0.type", "Number"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.0.title", "Network Status Summary"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.0.number_cards.#", "3"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.1.type", "Number"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.1.title", "Application Status Summary"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.1.number_cards.#", "3"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.2.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.2.title", "Application Availability Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.2.metric", "WEB_AVAILABILITY"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.2.timeseries_config.0.group_by", "TEST_TAG"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.3.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.3.title", "HTTP Response Time Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.3.metric", "WEB_TTFB"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.title", "Network Packet Loss Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.metric", "NET_LOSS"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.fixed_timespan.0.value", "2"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.fixed_timespan.0.unit", "Hours"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.5.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.5.title", "Application Latency Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.5.metric", "NET_LATENCY"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.6.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.6.title", "DNS Availability Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.6.metric", "DNS_SERVER_AVAILABILITY"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.6.timeseries_config.0.group_by", "SERVER"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.type", "Color Grid"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.title", "Network Packet Loss by Test"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.metric", "NET_LOSS"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.color_grid_config.0.cards", "TEST"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.type", "Color Grid"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.title", "Application Availability by Test"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.metric", "WEB_AVAILABILITY"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.color_grid_config.0.cards", "TEST"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.type", "Agent Status"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.title", "Agent Status"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.data_source", "CLOUD_AND_ENTERPRISE_AGENTS"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.agent_status_config.0.show", "All Assigned Agents"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.agent_status_config.0.agent_type", "Enterprise Agents"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "title", "Customer Dashboard A Updated"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "description", ""),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "is_private", "false"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.#", "10"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.0.type", "Number"),
				...
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.2.title", "Application Availability Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.3.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.3.title", "Network Packet Loss Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.4.title", "Application Latency Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.5.type", "Time Series: Line"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.5.title", "DNS Availability Timeline"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.5.timeseries_config.0.group_by", "SERVER"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.6.type", "Color Grid"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.type", "Agent Status"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.title", "Agent Status"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.data_source", "CLOUD_AND_ENTERPRISE_AGENTS"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.7.agent_status_config.0.show", "All Assigned Agents"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.type", "List"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.title", "Recent Events List"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.8.data_source", "EVENT_DETECTION"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.type", "Alert List"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.title", "Recent Alerts"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.data_source", "ALERTS"),
				resource.TestCheckResourceAttr(resourceNameCustomerShapeWidgetTypes, "widgets.9.alert_list_config.0.limit_to", "15"),
			},
		},
		{
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameTimeseriesWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameTimeseriesWidget, "widgets.0.timeseries_config.0.min_scale"),
				resource.TestCheckResourceAttrSet(resourceNameTimeseriesWidget, "widgets.0.timeseries_config.0.max_scale"),
				resource.TestCheckResourceAttr(resourceNameTimeseriesWidget, "widgets.0.timeseries_config.0.group_by", "AGENT"),
				resource.TestCheckResourceAttrSet(resourceNameTimeseriesWidget, "widgets.0.timeseries_config.0.show_timeseries_overall_baseline"),
				resource.TestCheckResourceAttrSet(resourceNameTimeseriesWidget, "widgets.0.timeseries_config.0.is_timeseries_one_chart_per_line"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameStackedAreaWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameStackedAreaWidget, "widgets.0.stacked_area_config.0.min_scale"),
				resource.TestCheckResourceAttrSet(resourceNameStackedAreaWidget, "widgets.0.stacked_area_config.0.max_scale"),
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameBoxAndWhiskersWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameBoxAndWhiskersWidget, "widgets.0.box_and_whiskers_config.0.min_scale"),
				resource.TestCheckResourceAttrSet(resourceNameBoxAndWhiskersWidget, "widgets.0.box_and_whiskers_config.0.max_scale"),
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameTableWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameTableWidget, "widgets.0.table_config.0.compare_to_previous_value"),
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameStackedBarChartWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameStackedBarChartWidget, "widgets.0.stacked_bar_chart_config.0.show_labels"),
				resource.TestCheckResourceAttrSet(resourceNameStackedBarChartWidget, "widgets.0.stacked_bar_chart_config.0.is_horizontal_bar_chart"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameGroupedBarChartWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameGroupedBarChartWidget, "widgets.0.grouped_bar_chart_config.0.show_labels"),
				resource.TestCheckResourceAttrSet(resourceNameGroupedBarChartWidget, "widgets.0.grouped_bar_chart_config.0.is_horizontal_bar_chart"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameColorGridWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameColorGridWidget, "widgets.0.color_grid_config.0.min_scale"),
				resource.TestCheckResourceAttrSet(resourceNameColorGridWidget, "widgets.0.color_grid_config.0.max_scale"),
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameAlertListWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameAlertListWidget, "widgets.0.alert_list_config.0.limit_to"),
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameNumberDefaults, "widgets.0.should_exclude_alert_suppression_windows"),
				...
				resource.TestCheckResourceAttrSet(resourceNameNumberDefaults, "widgets.0.number_cards.0.compare_to_previous_value"),
				resource.TestCheckResourceAttrSet(resourceNameNumberDefaults, "widgets.0.number_cards.0.should_exclude_alert_suppression_windows"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
				resource.TestCheckResourceAttr(resourceNameNumberDefaults, "title", "Test Dashboard Number Defaults"),
				resource.TestCheckResourceAttr(resourceNameNumberDefaults, "widgets.0.type", "Number"),
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttrSet(resourceNameMultiMetricTableWidget, "widgets.0.should_exclude_alert_suppression_windows"),
				resource.TestCheckResourceAttrSet(resourceNameMultiMetricTableWidget, "widgets.0.multi_metric_table_config.0.compare_to_previous_value"),
