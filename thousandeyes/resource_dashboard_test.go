	...
	var testCases = []struct {
		...
		},
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttr(resourceNameMultiMetricTableWidget, "widgets.0.multi_metric_columns.1.metric", "ALERT_COUNT"),
				resource.TestCheckResourceAttr(resourceNameMultiMetricTableWidget, "widgets.0.multi_metric_columns.1.measure.0.type", "TOTAL"),
			},
			checkUpdateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttr(resourceNameMultiMetricTableWidget, "widgets.0.multi_metric_columns.2.measure.0.type", "MAXIMUM"),
			},
		},
	}
