			...
			Steps: []resource.TestStep{
				{
					...
					resource.TestCheckResourceAttr(resourceName, "authentication.0.oauth_token_url", "https://example.com/oauth/token"),
					resource.TestCheckResourceAttrSet(resourceName, "id"),
				),
			},
		},
			...
			Steps: []resource.TestStep{
				{
					...
					resource.TestCheckResourceAttr(resourceName, "authentication.0.oauth_client_id", "test-client-id"),
					resource.TestCheckResourceAttr(resourceName, "authentication.0.oauth_token_url", "https://example.com/oauth/token"),
					resource.TestCheckResourceAttr(resourceName, "authentication.0.oauth_auth_url", "https://example.com/oauth/authorize"),
