	...
	var testCases = []struct {
	...
	}{
		{
			...
			checkCreateFunc: []resource.TestCheckFunc{
				...
				resource.TestCheckResourceAttr(resourceName, "requests.0.url", "https://www.thousandeyes.com"),
				...
				resource.TestCheckResourceAttr(resourceName, "requests.0.password", "test_password"),
				...
				resource.TestCheckResourceAttr(resourceName, "requests.1.url", "https://www.thousandeyes.com"),
				resource.TestCheckResourceAttr(resourceName, "requests.1.client_authentication", "in-body"),
				resource.TestCheckResourceAttr(resourceName, "requests.1.client_id", "test_client"),
				resource.TestCheckResourceAttr(resourceName, "requests.1.client_secret", "test_client_secret"),
				resource.TestCheckResourceAttr(resourceName, "requests.1.scope", "test_scope"),
				resource.TestCheckResourceAttr(resourceName, "requests.1.token_url", "https://www.thousandeyes.com"),
